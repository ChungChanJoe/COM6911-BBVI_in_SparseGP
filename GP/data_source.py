...
class DataSource:
    ...
    def bike_data():
        ...
        * Jarrett RG. A note on the intervals between coal-mining disasters. Biometrika. 1979;66(1):191-3.
        ...
        data = []
        trainX = pandas.read_csv('data/bike/bike_train_X.csv', header=None)
        trainY = pandas.read_csv('data/bike/bike_train_Y.csv', header=None)
        testX = pandas.read_csv('data/bike/bike_test_X.csv', header=None)
        testY = pandas.read_csv('data/bike/bike_test_Y.csv', header=None)
        data.append({
    ...
    def istanbul_data():
        ...
        * Jarrett RG. A note on the intervals between coal-mining disasters. Biometrika. 1979;66(1):191-3.
        ...
        data = []
        trainX = pandas.read_csv('data/Istanbul_stock/istanbul_train_X.csv', header=None)
        trainY = pandas.read_csv('data/Istanbul_stock/istanbul_train_Y.csv', header=None)
        testX = pandas.read_csv('data/Istanbul_stock/istanbul_test_X.csv', header=None)
        testY = pandas.read_csv('data/Istanbul_stock/istanbul_test_Y.csv', header=None)
        data.append({
            'train_Y': trainY.values,
            'train_X': trainX.values,
            'test_Y': testY.values,
    ...
    def istanbul_mul_data():
        ...
        * Jarrett RG. A note on the intervals between coal-mining disasters. Biometrika. 1979;66(1):191-3.
        ...
        data = []
        trainX = pandas.read_csv('data/Istanbul_mul/istanbul_mul_train_X.csv', header=None)
        trainY = pandas.read_csv('data/Istanbul_mul/istanbul_mul_train_Y.csv', header=None)
        testX = pandas.read_csv('data/Istanbul_mul/istanbul_mul_test_X.csv', header=None)
        testY = pandas.read_csv('data/Istanbul_mul/istanbul_mul_test_Y.csv', header=None)
        data.append({
            'train_Y': trainY.values,
            'train_X': trainX.values,
            'test_Y': testY.values,
